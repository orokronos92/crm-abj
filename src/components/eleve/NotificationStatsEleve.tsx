/**
 * Composant Stats pour les notifications élève
 */
...
interface NotificationStatsEleveProps {
  counts: {
    total: number
    nonLues: number
    urgentes: number
...
export function NotificationStatsEleve({ counts }: NotificationStatsEleveProps) {
  return (
    <div className="grid grid-cols-4 gap-4">
      <div className="card p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-[rgb(var(--muted-foreground))]">Mes notifications</p>
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between">
          ...
          <Calendar className="w-8 h-8 text-[rgb(var(--warning))]" />
        </div>
      </div>
    </div>
  )
