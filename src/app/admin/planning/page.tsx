/**
 * Page Planning (en développement)
      ...
      <div className="min-h-[600px] flex items-center justify-center">
        <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="text-left">
                ...
                <ul className="text-sm text-[rgb(var(--muted-foreground))] space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Calendrier interactif avec vue hebdomadaire/mensuelle</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[rgb(var(--accent))]">•</span>
                    <span>Croisement automatique disponibilités formateurs + salles + élèves</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[rgb(var(--accent))]">•</span>
                    <span>Optimisation IA des sessions (Marjorie suggère les meilleurs créneaux)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[rgb(var(--accent))]">•</span>
                    <span>Gestion des conflits et alertes automatiques</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[rgb(var(--accent))]">•</span>
                    <span>Export planning par formateur/salle/formation</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <p className="mt-8 text-xs text-[rgb(var(--muted-foreground))]">
            En attendant, vous pouvez gérer vos sessions depuis l'onglet <span className="text-[rgb(var(--accent))] font-semibold">Sessions</span>
          </p>
        </div>
      </div>
    </DashboardLayout>
