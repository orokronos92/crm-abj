/**
 * Page Mes Élèves - Interface Formateur
 * Le formateur ne voit que ses élèves attribués
 * Pas d'adresse ni téléphone, uniquement email
 */
...
// Données mockées élèves ATTRIBUÉS au formateur Marc Laurent
const MOCK_ELEVES = [
  {
    id: 1,
    nom: 'Fontaine',
  ...
  },
  {
    ...
    date_debut: '01/03/2024',
    date_fin: '20/12/2024',
    heures_effectuees: 275,
    heures_totales: 500,
    prochaine_eval: '16/02/2024 - Montage (pratique)',
    notes_moyennes: 13.8,
    absences: 4,
    ...
    evaluations: [
      {
        ...
        coeff: 2,
        sur: 20,
        commentaire: 'Bon travail, mais manque de régularité. Continue de pratiquer.',
        competences_validees: ['Base limage'],
        competences_a_travailler: ['Régularité', 'Finesse'],
      },
      {
        id: 2,
        date: '19/03/2024',
        ...
        coeff: 2,
        sur: 20,
        commentaire: 'Technique correcte, attention à la précision du tracé.',
        competences_validees: ['Sciage droit'],
        competences_a_travailler: ['Précision', 'Tracé courbe'],
      },
    ],
    presences: [
      { date: '01/03/2024', matin: 'PRESENT', apres_midi: 'PRESENT' },
      { date: '02/03/2024', matin: 'ABSENT_JUSTIFIE', apres_midi: 'ABSENT_JUSTIFIE', motif: 'Certificat médical' },
      { date: '03/03/2024', matin: 'RETARD', apres_midi: 'PRESENT', motif: 'Transport' },
      { date: '04/03/2024', matin: 'PRESENT', apres_midi: 'ABSENT', motif: 'Non justifié' },
    ],
    documents: [
      { type: 'Bulletin 1', statut: 'GENERE', date: '30/03/2024' },
      { type: 'Attestation assiduité', statut: 'EN_ATTENTE', date: null },
    ],
    historique: [
      { date: '01/03/2024', type: 'info', message: 'Début de formation' },
      { date: '02/03/2024', type: 'warning', message: 'Absence justifiée (certificat médical)' },
      { date: '04/03/2024', type: 'error', message: 'Absence non justifiée' },
      { date: '12/03/2024', type: 'success', message: 'Évaluation pratique limage (14/20)' },
      { date: '15/03/2024', type: 'error', message: 'Paiement en retard (3500€ restants)' },
    ],
  },
]
...
export default function FormateurElevesPage() {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-[rgb(var(--foreground))]">Mes Élèves</h1>
            <p className="text-[rgb(var(--muted-foreground))] mt-1">
              Vos élèves en formation active
            </p>
          </div>
        </div>
        ...
        <div className="p-4 bg-gradient-to-br from-[rgba(var(--accent),0.1)] to-[rgba(var(--accent),0.05)] border border-[rgba(var(--accent),0.2)] rounded-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-[rgb(var(--muted-foreground))] font-medium">Total élèves suivis</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-[rgb(var(--card))] border border-[rgba(var(--border),0.5)] rounded-xl overflow-hidden flex flex-col max-w-6xl w-full max-h-[90vh]">
            ...
            <div className="flex-1 overflow-y-auto p-6 min-h-[600px]">
              ...
              {activeTab === 'general' && (
                <div className="space-y-6">
                  {/* Photo + Identité (PAS DE TÉLÉPHONE) */}
              ...
              {/* Tab Synthèse (PAS D'INFOS FINANCIÈRES DÉTAILLÉES pour le formateur) */}
              {activeTab === 'synthese' && (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="p-4 bg-[rgb(var(--secondary))] rounded-lg">
                        <p className="text-xs text-[rgb(var(--muted-foreground))] mb-1">Financement</p>
